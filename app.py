...
LISTE_COMMUNES = sorted([
    "ABOMEY", "ABOMEY-CALAVI", "ADJARRA", "ADJOHOUN", "ADJA-OUERE", "AGBANGNIZOUN", "AGUEGUES", 
    "AKPRO-MISSERETE", "ALLADA", "APLAHOUÈ", "AVRANKOU", "BANIKOARA", "BANTE", "BASSILA", 
    "BEMBEREKE", "BOHICON", "BONOU", "BOPA", "BOUKOUMBE", "COBLY", "COME", "COPARGO", 
    "COTONOU", "COVE", "DANGBO", "DASSA-ZOUME", "DJAKOTOMEY", "DJIDJA", "DJOUGOU", "DOGBO", 
    "GLAZOUE", "GOGOUNOU", "GRAND-POPO", "HOUEYOGBE", "IFANGNI", "KALALE", "KANDI", "KEROU", 
    "KETOU", "KLOUEKANME", "KOUANDE", "LALO", "LOKOSSA", "MALANVILLE", "MATERI", "N'DALI", 
    "NATITINGOU", "NIKKI", "OUAKE", "OUESSE", "OUIDAH", "OUINHI", "PERERE", "PEHUNCO", 
    "POBE", "PORTO-NOVO", "SAKETE", "SAVALOU", "SAVE", "SEGBANA", "SEME-KPODJI", "SINENDE", 
    "SO-AVA", "TANGUIETA", "TCHAOUROU", "TOFFO", "TORI-BOSSITO", "TOUCOUNTOUNA", "TOVIKLIN", 
    "ZA-KPOTA", "ZAGNANADO", "ZE", "ZOGBODOMEY"
])
